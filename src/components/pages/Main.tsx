...
function Main() {
    ...
    useEffect(()=> {
        axios.get(`https://jsonplaceholder.typicode.com/users`,{params: {_limit:6}})
...
<div className="chat_contact">
    <div className="chat_profile"><img src='./img/profile_photo.png' alt='some value'/></div>
...
<div className="chat_panel">
    <ul>
        ...
        <li className="tasks"><a href="#/">Tasks</a></li>
        <li className="email"><a href="#/">Email</a></li>
        <li className="contacts"><a href="#/">Contacts</a></li>
        <li className="chats"><a href="#/">Chat</a></li>
        <li className="deals"><a href="#/">Deals</a></li>
        </ul>
        <hr/>
        <ul>
...
<div className="content_main">
    ...
    <form action="formdata" method="post" name="form1" >
        <p>Company:<select name="list1" id='input2'>
    ...
    <input className="button" type="button" value="Add contact" id="button1"/>
    </div>
